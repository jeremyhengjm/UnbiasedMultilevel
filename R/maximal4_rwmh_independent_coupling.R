#' @rdname maximal4_rwmh_independent_coupling
#' @title independent maximal coupling of 4 RWM proposals
#' @description Generate RWM proposals for two chains via maximal coupling for pairs of chains at the coarse and fine levels independently
...
maximal4_rwmh_independent_coupling <- function(chain_state_coarse1, chain_state_coarse2,
  ...
  maximal_output <- maximal2_rwmh_coupling(chain_state_coarse1, chain_state_coarse2, identical_coarse, tuning_coarse)
  ...
  maximal_output <- maximal2_rwmh_coupling(chain_state_fine1, chain_state_fine2, identical_fine, tuning_fine)
