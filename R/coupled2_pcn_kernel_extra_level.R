#' @rdname coupled2_pcn_kernel_extra_level
#' @title pCN kernel for two coupled chains that target distribitions at different levels
...
#' @param tuning a list of parameters neeeded for pCN (standard deviation and rho)
...
coupled2_pcn_kernel_extra_level <- function(level,
                                            state1, state2,
                                            identical,
                                            tuning,
                                            proposal_coupling){
  cost = 0  # cost of calculations
  # extract states
