#' @rdname coupled2_pcn_kernel_ext
#' @title pCN kernel for two chains that target distributions at different levels with synchronous couling of pCN proposals
...
coupled2_pcn_kernel_ext <- function(level, state1, state2, tuning1, tuning2){
  cost = 0
  ...
  proposal_value <- synchronous2_pcn_coupling_ext(level, chain_state1, chain_state2, tuning1, tuning2)
