# This script generates data for estimation of the decay of the second moments of increments
rm(list=ls())
library(Rcpp)
library(RcppCNPy)
...
for(kreal in 1 : nreal)
{
    ...
    for(vlevel in 0 : nlevel)
    {
        ...
        for(kiter in 1 : niter)
        {
            ...
            fname = paste0("./covid19_second_moment_pcn_level_", vlevel, ".rds")
            saveRDS(sgd_vec, file = fname)
            fname = paste0("./covid19_second_moment_pcn_level_", vlevel, ".npy")
