...
# os the second moments of the increments estimated with pCN reflection maximal coupling
rm(list=ls())
...
for(kreal in 1 : nreal)
{
    ...
    for(vlevel in 0 : nlevel)
    {
        ...
        for(kiter in 1 : niter)
        {
            ...
            fname = paste0("./toyexample_second_moment_pcn_level_", vlevel, ".rds")
            saveRDS(sgd_vec, file = fname)
            fname = paste0("./toyexample_second_moment_pcn_level_", vlevel, ".npy")
